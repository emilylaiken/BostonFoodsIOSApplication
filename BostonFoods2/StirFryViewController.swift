...
class StirFryViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    
    //Picker object for number of servings
    @IBOutlet weak var myPicker: UIPickerView!
    //Data for picker object
    var pickerData: [String] = [String]()
    //Text field object for ingredient quantity
    @IBOutlet weak var chickenOutput: UITextField!
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        //calculate quantity of chicken
        let chickenQuantity = servingsNum! * 4
        chickenOutput.text = String(chickenQuantity)
    }
