...
class ChickenViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var chickenBreastsOutput: UITextField!
    @IBOutlet weak var butterSticksOutput: UITextField!
    @IBOutlet weak var oliveOilOutput: UITextField!
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        //calculate quantity of chicken breasts
        chickenBreastsOutput.text = servingsString
        //calculate quantity of butter sticks
        let butterSticksQuantity = servingsNum! / 4
        butterSticksOutput.text = String(butterSticksQuantity)
        //calculate spoonfuls of olive oil
        let oliveOilQuantity = servingsNum! * (3/4)
        oliveOilOutput.text = String(oliveOilQuantity)
    }
